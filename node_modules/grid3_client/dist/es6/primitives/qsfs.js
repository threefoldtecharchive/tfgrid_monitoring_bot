...
import { Encryption, QuantumCompression, QuantumSafeConfig, QuantumSafeFS, QuantumSafeFSConfig, QuantumSafeMeta, } from "../zos/qsfs";
...
class QSFSPrimitive {
    ...
    metaType = "zdb", redundantGroups = 0, redundantNodes = 0, encryptionAlgorithm = "AES", compressionAlgorithm = "snappy", metadata = "", description = "", version = 0) {
        ...
        quantumSafeFS.cache = cache * Math.pow(1024, 3);
