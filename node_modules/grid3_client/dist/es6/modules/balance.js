...
class Balance {
    ...
    get(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.balance.get(options.address);
        });
    }
    transfer(options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.balance.transfer(options.address, options.amount);
        });
    }
    getMyBalance() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.balance.getMyBalance();
        });
    }
}
__decorate([
    ...
    __metadata("design:paramtypes", [BalanceGetModel]),
...
__decorate([
    ...
    checkBalance,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [BalanceTransferModel]),
    __metadata("design:returntype", Promise)
