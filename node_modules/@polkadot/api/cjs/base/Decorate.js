...
class Decorate extends _Events.Events {
  ...
  _decorateStorageRange(decorated, args, range) {
    ...
    return this._rpcCore.state.queryStorage([decorated.key(...args)], ...range).pipe((0, _rxjs.map)(result => result.map(_ref12 => {
      let [blockHash, [value]] = _ref12;
  ...
  _retrieveMapKeys(_ref13, at, args) {
    let {
      iterKey,
      meta,
      method,
  ...
  _retrieveMapKeysPaged(_ref14, at, opts) {
    let {
      iterKey,
      meta,
      method,
