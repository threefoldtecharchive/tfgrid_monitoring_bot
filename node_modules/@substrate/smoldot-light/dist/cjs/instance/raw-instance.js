...
const index_js_1 = require("../tiny-inflate/index.js");
...
function startInstance(config, platformBindings) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const wasmBytecode = new Uint8Array(wasm_js_1.decompressedSize);
        (0, index_js_1.default)(buffer.trustedBase64Decode(wasm_js_1.default), wasmBytecode);
        let killAll;
